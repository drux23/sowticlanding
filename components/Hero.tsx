...
// Replace figma asset with local placeholder image
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white">
          <h1 className="text-4xl md:text-6xl lg:text-7xl mb-6 drop-shadow-2xl">
            Soluciones tecnológicas para impulsar tus proyectos
          </h1>
          <p className="text-lg md:text-xl text-white/95 mb-8 max-w-2xl mx-auto drop-shadow-lg">
            Descubre una plataforma revolucionaria que te llevará más allá de
            los límites. Cada aventura comienza con un solo paso hacia lo
            extraordinario.
          </p>
            ...
            >
              ...
              >
                ...
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  <div
                    className="absolute top-5 left-8 w-0.5 h-0.5 bg-white/20 rounded-full animate-bounce"
                    style={{ animationDelay: "0s", animationDuration: "3s" }}
                  />
                  <div
                    className="absolute top-7 right-10 w-1 h-1 bg-white/15 rounded-full animate-bounce"
                    style={{
                      animationDelay: "0.8s",
                  ...
                  />
                  <div
                    className="absolute bottom-7 left-12 w-0.5 h-0.5 bg-white/18 rounded-full animate-bounce"
                    style={{
                      animationDelay: "1.6s",
                  ...
                  />
                  <div
                    className="absolute bottom-5 right-8 w-0.5 h-0.5 bg-white/22 rounded-full animate-bounce"
                    style={{
                      animationDelay: "2.4s",
                ...
                <span className="flex-1 text-center relative z-10 group-hover:text-white transition-colors duration-500">
                  Contacto
                </span>
