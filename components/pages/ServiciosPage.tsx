  ...
  const services = [
    {
      ...
      title: "Agentes IA",
      description:
        "Desarrollamos agentes de inteligencia artificial personalizados que automatizan procesos complejos y mejoran la toma de decisiones en tu empresa.",
      features: [
    ...
    },
    {
      ...
      description:
        "Protegemos tu infraestructura digital con soluciones de ciberseguridad avanzadas y monitoreo continuo de amenazas.",
      features: [
    ...
    },
    {
      ...
      description:
        "Diseñamos y gestionamos infraestructuras tecnológicas escalables y seguras para impulsar el crecimiento de tu negocio.",
      features: [
    ...
    },
    {
      ...
      description:
        "Creamos experiencias inmersivas de realidad aumentada que transforman la forma en que tus clientes interactúan con tus productos.",
      features: [
        "Aplicaciones móviles AR",
        "Visualización 3D",
        "Training interactivo",
        "Marketing inmersivo",
      ],
    },
  ];
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              Soluciones tecnológicas especializadas para transformar tu negocio
              y potenciar tu crecimiento digital
            </p>
          </div>
        </div>
      </section>
